...
public class Ex05Application {
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			List<Student> lstSAgeThan19 = studentRepository.findByAgeGreaterThan1(19);
			print(lstSAgeThan19);
			System.out.println("list of students whose ielts score is equal to 7.0: ");
			List<Student> lstSILScore = studentRepository.findByIeltsScore1("7.0");
			print(lstSILScore);
			System.out.println("List of students whose name contains the word n: ");
			List<Student> lstSNameLike = studentRepository.findByNameContaining1("n");
			print(lstSNameLike);
		};
	}
